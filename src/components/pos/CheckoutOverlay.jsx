      ...
      <div className="shell-surface modal-panel-enter sales-highlight-ring flex h-full w-full max-w-md flex-col">
        ...
        <div className="checkout-body custom-scrollbar flex-1 overflow-y-auto">
          ...
          <div className="checkout-total sales-panel-enter bg-blue-600 px-6 rounded-2xl text-center shadow-lg shadow-blue-100" style={{ animationDelay: "120ms" }}>
            ...
            <h1 className="checkout-amount font-black text-white">{formatCurrency(normalizedTotal)}</h1>
          </div>
          ...
          <div className="sales-panel-enter grid grid-cols-2 gap-4" style={{ animationDelay: "180ms" }}>
            <button
              ...
              className={`checkout-method flex flex-col items-center justify-center rounded-xl border-2 transition-all ${
                orderType === ORDER_TYPES.CASH 
